                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        adresse!.googleAddress == null ||
                            ...
                            : Column(
                                children: [
                                  ...
                                  ListTileCustom(
                                    title: "edit_ad.ga".tr(),
                                    subtitle: adresse!.googleAddress!,
                                  ),
                                ],
                              ),
                        // adresse!.codePin == null ||
                        //         adresse!.codePin!.bitLength < 4
                        //     ? const SizedBox()
                        //     : Column(
                        //         children: [
                        //           const SizedBox(height: 20),
                        ...
                        //             subtitle: adresse!.codePin!.toString(),
                        //           ),
                        //         ],
                        //       ),
                        // Container(
                                ...
                                children: [
                                  if (adresse?.media?.video1 != null)
                                    Expanded(
                                      child: AdresseVideo(
                                        video:
                                            "${APIURL.fileUrl}/${adresse!.media!.video1!}",
                                        size: size,
                                        isEdit: false,
                                      ),
                                    ),
                                  ...
                                  if (adresse?.media?.video2 != null)
                                    Expanded(
                                      child: AdresseVideo(
                                        video:
                                            "${APIURL.fileUrl}/${adresse!.media!.video2!}",
                                        size: size,
                                        isEdit: false,
                                      ),
                                    ),
